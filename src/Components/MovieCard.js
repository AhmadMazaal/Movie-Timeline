...
export default function MovieCard(props){
    ...
    if(movies !== undefined && type === 'query' ){
        ...
        >{ props =>(
            ...
            <h1 className="movie-category" >Search Result For <span className="search-result">"{ searchResult }"</span></h1>
                    ...
                    <div  key={movie.id} style={props}>
                        <div className="card">
                            ...
                            <div className="card--content">
                                ...
                                <Link style={{textDecoration:"none"}}  to="/"><p style={{fontSize:"1.5rem",fontWeight:"bold",color:"#333"}}>Add to favorites <FaPlus size="1.2rem" color={Colors.warning}/></p></Link>
        ...
        >{ props =>(
            ...
            {movieCategory.filter(movieCategory => movieCategory.poster_path).map(movieCategory => 
                    <div  key={movieCategory.id} style={props}>
                        <div className="card">

                            <img className="card--image" src={`https://image.tmdb.org/t/p/w185_and_h278_bestv2/${movieCategory.poster_path}`}
                            ...
                            <div className="card--content">
                                ...
                                <p><small>RELEASE DATE: {movieCategory.release_date}</small></p>
                                <p><small>RATING: {movieCategory.vote_average}</small></p>
